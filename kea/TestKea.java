...
//		 B. optional arguments if you want to change the defaults
	...
	private void setOptionsTesting(String m_testdir, String model_file) {
		...
		ke.setModelName("testdocs/en/" + model_file);
...
//		 B. optional arguments if you want to change the defaults
		...
		// 11. Set to true, if you want to get scores for the keywords		
		ke.setAdditionalInfo(false);		
	}
...
//		test.createModel();
		...
		test.setOptionsTesting(m_testdir, args[0]);
